...
@section('content')
    ...
    {{ html()->form('put', route('profile.update_email'))->open() }}
        <div class="mb-8">
            ...
            {{ html()->email('current_email')->attributes(['class' => 'input' . ($errors->has('current_email') ? ' has-error' : ''), 'placeholder' => __('validation.attributes.current_email')])->required() }}
        ...
        <div class="mt-6 mb-4">
            ...
            {{ html()->email('new_email', old('new_email'))->attributes(['class' => 'input' . ($errors->has('new_email') ? ' has-error' : ''), 'placeholder' => __('validation.attributes.new_email')])->required() }}
        ...
        <div class="mb-4">
            ...
            {{ html()->email('new_email_confirmation')->attributes(['class' => 'input' . ($errors->has('new_email_confirmation') ? ' has-error' : ''), 'placeholder' => __('validation.attributes.new_email_confirmation')])->required() }}
