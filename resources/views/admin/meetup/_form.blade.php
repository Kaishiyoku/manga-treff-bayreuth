<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('date_start', old('date_start', $meetup->date_start->format(__('date.short'))), ['class' => 'form-control' . ($errors->has('date_start') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('date_end', old('date_end', $meetup->date_end->format(__('date.short'))), ['class' => 'form-control' . ($errors->has('date_end') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('country', old('country', $meetup->country), ['class' => 'form-control' . ($errors->has('country') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('state', old('state', $meetup->state), ['class' => 'form-control' . ($errors->has('state') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('address', old('address', $meetup->address), ['class' => 'form-control' . ($errors->has('address') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('zip', old('zip', $meetup->zip), ['class' => 'form-control' . ($errors->has('zip') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-3">
        {{ Form::text('city', old('city', $meetup->city), ['class' => 'form-control' . ($errors->has('city') ? ' is-invalid' : ''), 'required' => true]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-10">
        {{ Form::textarea('intro', old('intro', $meetup->intro), ['class' => 'form-control' . ($errors->has('intro') ? ' is-invalid' : ''), 'required' => true, 'rows' => 5]) }}
...
<div class="form-group row">
    ...
    <div class="col-lg-10">
        {{ Form::textarea('description', old('description', $meetup->description), ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'required' => true]) }}
